...
intermediate <- read.csv("mrMLMM2/Resultfloall1/15_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
if (nrow(P.less.0.05) > 0){
  ...
  P.less.0.05 <- P.less.0.05[,c(11,10,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/Resultfloall1/15_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  levels(mrmlm.final$Trait.name)[levels(mrmlm.final$Trait.name) == "Trait30"] <- "GFW_50"
  mrmlm.final$P.value <- 10^-(mrmlm.final$X.log10.P.)
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
  ##combine the result from above two
  ## Vertical
  ...
  total <- tibble::rowid_to_column(total, "ID")
  ###write the result
  write.csv(total, file="allresults/GFW_50_2.csv",row.names = F)
...
if (nrow(P.less.0.05) > 0){
  ...
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  levels(mrmlm.final$Trait.name)[levels(mrmlm.final$Trait.name) == "Trait31"] <- "HM_1"
  mrmlm.final$P.value <- 10^-(mrmlm.final$X.log10.P.)
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
  ##combine the result from above two
  ## Vertical
...
if (nrow(P.less.0.05) > 0){
  ...
  P.less.0.05 <- P.less.0.05[,c(11,10,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("Resultfloall1/19_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  levels(mrmlm.final$Trait.name)[levels(mrmlm.final$Trait.name) == "Trait34"] <- "FM_50"
  mrmlm.final$P.value <- 10^-(mrmlm.final$X.log10.P.)
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
  ##combine the result from above two
  ## Vertical
