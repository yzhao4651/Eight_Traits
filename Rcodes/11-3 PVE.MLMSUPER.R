...
MLMSUPER0.05.F106.flo.S <- MLMSUPER0.05.F106.flo.S[-18]
write.csv(MLMSUPER0.05.F106.flo.S,file="GAPIT0.05Result/MLMSUPER0.05.F106.flo.S.csv")
...
flo <- flo.1[flo.1$Ind.SNP=="F116+3098" & flo.1$Method=="MLM+SUPER",]

flo <- flo[!(flo$Trait.name=="Surv"),]
flo <- droplevels(flo)
levels(as.factor(flo$Trait.name))
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/MLMSUPER0.05.F116up")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("MLMSUPER0.05.F116up/*.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
  sample.PVE <- PVE.fun(sample,myY,myGD)
...
MLMSUPER0.05.F116$filename <- gsub('MLMSUPER0.05.F116up/Trait.', '', MLMSUPER0.05.F116$filename)
...
write.csv(MLMSUPER0.05.F116.flo.S,file="GAPIT0.05Result/MLMSUPER0.05.F116.flo.S.csv")
...
flo <- flo.1[flo.1$Ind.SNP=="F96+4814" & flo.1$Method=="MLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]
flo <- droplevels(flo)
levels(as.factor(flo$Trait.name))
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/MLMSUPER0.05.F96")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("MLMSUPER0.05.F96/*.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
  sample.PVE <- PVE.fun(sample,myY,myGD)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
MLMSUPER0.05.F96 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(MLMSUPER0.05.F96$filename)

MLMSUPER0.05.F96$filename <- gsub('MLMSUPER0.05.F96/Trait.', '', MLMSUPER0.05.F96$filename)
MLMSUPER0.05.F96$filename <- gsub('.csv', '', MLMSUPER0.05.F96$filename)

levels(as.factor(MLMSUPER0.05.F96$filename))

MLMSUPER0.05.F96.1 <- unite(MLMSUPER0.05.F96,"SNP.T",SNP,filename,sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

MLMSUPER0.05.F96.flo <- merge(flo.2,MLMSUPER0.05.F96.1,by="SNP.T")
MLMSUPER0.05.F96.flo.S <- separate(MLMSUPER0.05.F96.flo, SNP.T, c("SNP","Trait.name"),sep="/")
write.csv(MLMSUPER0.05.F96.flo.S,file="GAPIT0.05Result/MLMSUPER0.05.F96.flo.S.csv")
...
###for OWA 102
###for OWA 102
###for OWA 102 this one is no result
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
...
flo.1 <- read.csv("GAPIT0.05Result/SUPER0.05.PS.csv")
flo <- flo.1[flo.1$Ind.SNP=="O102+4322" & flo.1$Method=="MLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]


setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/MLMSUPER0.05.O102")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("MLMSUPER0.05.O102/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
MLMSUPER0.05.O102 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(MLMSUPER0.05.O102$filename)

MLMSUPER0.05.O102$filename <- gsub('MLMSUPER0.05.O102/Trait.', '', MLMSUPER0.05.O102$filename)
MLMSUPER0.05.O102$filename <- gsub('.csv', '', MLMSUPER0.05.O102$filename)

levels(as.factor(MLMSUPER0.05.O102$filename))

MLMSUPER0.05.O102.1 <- unite(MLMSUPER0.05.O102,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

MLMSUPER0.05.O102.flo <- merge(flo.2,MLMSUPER0.05.O102.1,by="SNP.T")
MLMSUPER0.05.O102.flo.S <- separate(MLMSUPER0.05.O102.flo, SNP.T, c("SNP","Trait.name"),sep="/")
write.csv(MLMSUPER0.05.O102.flo.S,file="GAPIT0.05Result/MLMSUPER0.05.O102.flo.S.csv")
...
##for OWA 112
###for OWA 112
###for OWA 112 this one no result 
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
...
flo.1 <- read.csv("GAPIT0.05Result/SUPER0.05.PS.csv")
flo <- flo.1[flo.1$Ind.SNP=="O112+3450" & flo.1$Method=="MLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]


setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/MLMSUPER0.05.O112")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("MLMSUPER0.05.O112/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
MLMSUPER0.05.O112 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(MLMSUPER0.05.O112$filename)

MLMSUPER0.05.O112$filename <- gsub('MLMSUPER0.05.O112/Trait.', '', MLMSUPER0.05.O112$filename)
MLMSUPER0.05.O112$filename <- gsub('.csv', '', MLMSUPER0.05.O112$filename)

levels(as.factor(MLMSUPER0.05.O112$filename))

MLMSUPER0.05.O112.1 <- unite(MLMSUPER0.05.O112,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

MLMSUPER0.05.O112.flo <- merge(flo.2,MLMSUPER0.05.O112.1,by="SNP.T")
MLMSUPER0.05.O112.flo.S <- separate(MLMSUPER0.05.O112.flo, SNP.T, c("SNP","Trait.name"),sep="/")
write.csv(MLMSUPER0.05.O112.flo.S,file="GAPIT0.05Result/MLMSUPER0.05.O112.flo.S.csv")
...
flo.1 <- read.csv("GAPIT0.05Result/SUPER0.05.PS.csv")
flo <- flo.1[flo.1$Ind.SNP=="O122+2646" & flo.1$Method=="MLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]


setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/MLMSUPER0.05.O122")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("MLMSUPER0.05.O122/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
MLMSUPER0.05.O122 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(MLMSUPER0.05.O122$filename)

MLMSUPER0.05.O122$filename <- gsub('MLMSUPER0.05.O122/Trait.', '', MLMSUPER0.05.O122$filename)
MLMSUPER0.05.O122$filename <- gsub('.csv', '', MLMSUPER0.05.O122$filename)

levels(as.factor(MLMSUPER0.05.O122$filename))

MLMSUPER0.05.O122.1 <- unite(MLMSUPER0.05.O122,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

MLMSUPER0.05.O122.flo <- merge(flo.2,MLMSUPER0.05.O122.1,by="SNP.T")
MLMSUPER0.05.O122.flo.S <- separate(MLMSUPER0.05.O122.flo, SNP.T, c("SNP","Trait.name"),sep="/")
str(MLMSUPER0.05.O122.flo.S)
write.csv(MLMSUPER0.05.O122.flo.S,file="GAPIT0.05Result/MLMSUPER0.05.O122.flo.S.csv")


###combine all of the result
MLMSUPER0.05.PVE.a.2 <- do.call("rbind",list(MLMSUPER0.05.C106.flo.S,MLMSUPER0.05.C116.flo.S,MLMSUPER0.05.C124.flo.S,
                                        MLMSUPER0.05.O112.flo.S,MLMSUPER0.05.O122.flo.S,MLMCUPERim.flo.S,
                                        MLMSUPER0.05.F106.flo.S,MLMSUPER0.05.F116.flo.S,MLMSUPER0.05.F96.flo.S))
