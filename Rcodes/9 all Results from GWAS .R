...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/")
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/IMFloimPS/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
...
###f106,116,122 rmlmm
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/F*PS/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
  mz.idx = which(sample$X..log10.P..!= Inf)
...
rMLMMCVfloall$filename <- gsub('PS', '/PS_Y', rMLMMCVfloall$filename)
...
rMLMMCVfloall.1$Ind.SNP <- gsub("C124", 'C124+2560', rMLMMCVfloall.1$Ind.SNP)
...
rMLMMCVfloall.1$Ind.SNP <- gsub("F116", 'F116+3098', rMLMMCVfloall.1$Ind.SNP)
rMLMMCVfloall.1$Ind.SNP <- gsub("F96", 'F96+4814', rMLMMCVfloall.1$Ind.SNP)
rMLMMCVfloall.1$Ind.SNP <- gsub("IMFloim", "F116+36088im", rMLMMCVfloall.1$Ind.SNP)

levels(as.factor(rMLMMCVfloall.1$Ind.SNP))
str(rMLMMCVfloall.1)
colnames(rMLMMCVfloall.1)
...
str(rMLMMCVfloall.2)
levels(rMLMMCVfloall.2$Trait.name)
write.csv(rMLMMCVfloall.2,file="GAPIT0.05Result/rMLMMflo.PS.csv")


####  flo NO NO CV
###rmlmm without CV
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/IMFloimPSNO/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
  mz.idx = which(sample$X..log10.P..!= Inf)
...
###f106, 116, 96 rmlmm NO CV
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/F*NO/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
  mz.idx = which(sample$X..log10.P..!= Inf)
...
rMLMMNOCVfloall$filename <- gsub('PSNO', '/PS_N', rMLMMNOCVfloall$filename) 
...
rMLMMNOCVfloall.1$Ind.SNP <- gsub("C124", 'C124+2560', rMLMMNOCVfloall.1$Ind.SNP)
...
rMLMMNOCVfloall.1$Ind.SNP <- gsub("F116", 'F116+3098', rMLMMNOCVfloall.1$Ind.SNP)
rMLMMNOCVfloall.1$Ind.SNP <- gsub("F96", 'F96+4814', rMLMMNOCVfloall.1$Ind.SNP)
rMLMMNOCVfloall.1$Ind.SNP <- gsub("IMFloim", "F116+36088im", rMLMMNOCVfloall.1$Ind.SNP)
...
levels(as.factor(rMLMMNOCVfloall.2$Ind.SNP))
write.csv(rMLMMNOCVfloall.2,file="GAPIT0.05Result/rMLMMflo.PSNO.csv")
...
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/SRDimPS/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
  mz.idx = which(sample$X..log10.P..!= Inf)
...
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/ResultOWA2allPS/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
  mz.idx = which(sample$X..log10.P..!= Inf)
...
levels(rMLMMCVOWAim$Trait.name)[levels(rMLMMCVOWAim$Trait.name)=="Trait1"] <- "OWA.18"
levels(rMLMMCVOWAim$Trait.name)[levels(rMLMMCVOWAim$Trait.name)=="Trait2"] <- "OWA.19"
str(rMLMMCVOWAim)

###rmlmm CV OWA with non missing value
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/O*PS/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
...
#resultImputedSNPCV <- plyr::ldply(mzList, data.frame)
#rMLMMCVOWAnm<- plyr::rbind.fill(mzList)
rMLMMCVOWAnm <- do.call("rbind", mzList)
levels(rMLMMCVOWAnm$Trait.name)[levels(rMLMMCVOWAnm$Trait.name)=="Trait1"] <- "OWA.18"
levels(rMLMMCVOWAnm$Trait.name)[levels(rMLMMCVOWAnm$Trait.name)=="Trait2"] <- "OWA.19"
str(rMLMMCVOWAnm)
...
###rmlmm NO CV SRD
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/SRDimPSNO/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
  names(sample)[names(sample)=="Var_phen.total."] <- "Var_phen..total."
...
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/ResultOWA2allPSNO/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
  names(sample)[names(sample)=="Var_phen.total."] <- "Var_phen..total."
...
levels(rMLMMOWANOCVim$Trait.name)[levels(rMLMMOWANOCVim$Trait.name)=="Trait1"] <- "OWA.18"
levels(rMLMMOWANOCVim$Trait.name)[levels(rMLMMOWANOCVim$Trait.name)=="Trait1"] <- "OWA.19"
str(rMLMMOWANOCVim)


###rmlmm NO CV OWA with non missing value
extension <- "csv"
fileNames <- Sys.glob(paste("mrMLMM2/O*PSNO/*Final result.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i])
  names(sample)[names(sample)=="Var_phen.total."] <- "Var_phen..total."
...
levels(rMLMMOWANOCVnm$Trait.name)[levels(rMLMMOWANOCVnm$Trait.name)=="Trait1"] <- "OWA.18"
levels(rMLMMOWANOCVnm$Trait.name)[levels(rMLMMOWANOCVnm$Trait.name)=="Trait2"] <- "OWA.19"
str(rMLMMOWANOCVnm)
levels(as.factor(rMLMMOWANOCVnm$filename))
