...
flo <- droplevels(flo)
levels(flo$Trait.name)
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/FarmCPU0.05.O102")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("FarmCPU0.05.O102/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
FarmCPU0.05.O102 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(FarmCPU0.05.O102$filename)

FarmCPU0.05.O102$filename <- gsub('FarmCPU0.05.O102/Trait.', '', FarmCPU0.05.O102$filename)
FarmCPU0.05.O102$filename <- gsub('.csv', '', FarmCPU0.05.O102$filename)

levels(as.factor(FarmCPU0.05.O102$filename))

FarmCPU0.05.O102.1 <- unite(FarmCPU0.05.O102,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

FarmCPU0.05.O102.flo <- merge(flo.2,FarmCPU0.05.O102.1,by="SNP.T")
FarmCPU0.05.O102.flo.S <- separate(FarmCPU0.05.O102.flo, SNP.T, c("SNP","Trait.name"),sep="/")
...
flo <- droplevels(flo)
levels(flo$Trait.name)
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/FarmCPU0.05.O112")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("FarmCPU0.05.O112/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
FarmCPU0.05.O112 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(FarmCPU0.05.O112$filename)

FarmCPU0.05.O112$filename <- gsub('FarmCPU0.05.O112/Trait.', '', FarmCPU0.05.O112$filename)
FarmCPU0.05.O112$filename <- gsub('.csv', '', FarmCPU0.05.O112$filename)

levels(as.factor(FarmCPU0.05.O112$filename))

FarmCPU0.05.O112.1 <- unite(FarmCPU0.05.O112,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

FarmCPU0.05.O112.flo <- merge(flo.2,FarmCPU0.05.O112.1,by="SNP.T")
FarmCPU0.05.O112.flo.S <- separate(FarmCPU0.05.O112.flo, SNP.T, c("SNP","Trait.name"),sep="/")
...
flo <- droplevels(flo)
levels(flo$Trait.name)
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/FarmCPU0.05.O122")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("FarmCPU0.05.O122/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
FarmCPU0.05.O122 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(FarmCPU0.05.O122$filename)

FarmCPU0.05.O122$filename <- gsub('FarmCPU0.05.O122/Trait.', '', FarmCPU0.05.O122$filename)
FarmCPU0.05.O122$filename <- gsub('.csv', '', FarmCPU0.05.O122$filename)

levels(as.factor(FarmCPU0.05.O122$filename))

FarmCPU0.05.O122.1 <- unite(FarmCPU0.05.O122,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

FarmCPU0.05.O122.flo <- merge(flo.2,FarmCPU0.05.O122.1,by="SNP.T")
FarmCPU0.05.O122.flo.S <- separate(FarmCPU0.05.O122.flo, SNP.T, c("SNP","Trait.name"),sep="/")
...
FarmCPU0.05.PVE.a <- do.call("rbind",list(FarmCPUCVNOim.flo.S,FarmCPU0.05.C106.flo.S,FarmCPU0.05.C116.flo.S,FarmCPU0.05.C124.flo.S,
                                        FarmCPU0.05.F106.flo.S,FarmCPU0.05.F116.flo.S,FarmCPU0.05.F96.flo.S,FarmCPU0.05.O102.flo.S,
                                        FarmCPU0.05.O112.flo.S,FarmCPU0.05.O122.flo.S))
